							...
							<div class="add-product-content">
								<div class="row">
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<input type="text" class="input-field" placeholder="{{ __('Enter Product Name') }}" name="name_ar" required="" value="{{ $data->name_ar }}">
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<input type="text" class="input-field" placeholder="{{ __('Enter Product Name') }}" name="name_ku" value="{{ $data->name_ku }}">
										</div>
									</div>
