...
<div class="content-area" >
    ...
    <div class="row row-cards-one" style="margin-right:35px;" >
        <div class="col-md-12 col-lg-6 col-xl-4"  style="padding-left:0.3px" >
    ...
    <div class="row row-cards-one" style="margin-right:30px">
        <div class="col-md-6 col-lg-6 col-xl-6"  style="padding-left:0.3px">
            <div class="card">
                <h5 class="card-header" style="text-align:center;">{{ __('Recent Product(s)') }}</h5>
                <div class="card-body">
    ...
    <div class="row row-cards-one" style="margin-right:30px">
        ...
        <div class="col-md-12 col-lg-12 col-xl-12"  style="padding-left:0.3px">
            <div class="card">
