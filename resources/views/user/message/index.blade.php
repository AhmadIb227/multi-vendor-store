        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="widget border-0 p-40 widget_categories bg-light account-info">
              ...
              <!--  </a>-->
              <!--</h4>-->
               <button type="button" class="btn " style="background-color:#1e19ff ; color:#FFFFFF" data-bs-toggle="modal" data-bs-target="#messageModal">
 {{ __('Compose Message') }}</button>
              <div class="mr-table allproduct message-area  mt-4">
                @include('alerts.form-success')
                <div class="">
                  <table id="example" class="table" style="background-color:#472C7A" cellspacing="0" width="100%">
                    <thead>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="messageModalLabel">{{ __('Send a new message') }}</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <form action="{{ route('sendMessage') }}" method="POST">
        @csrf
        <div class="modal-body">
          <!-- البريد الإلكتروني للمستخدم المستلم -->
