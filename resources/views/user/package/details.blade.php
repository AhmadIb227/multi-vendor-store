...
<div class="full-row">
    <div class="container">
        <div class="mb-4 d-xl-none">
            <!--<button class="dashboard-sidebar-btn btn  rounded" style="background-color:#8c6dd9">-->
                    ...
                    <div class="col-lg-12">
                        <div class="widget border-0 p-40 widget_categories bg-light account-info">
                            ...
                            <div class="pack-details">
                                ...
                                <form id="subscribe-form" class="pay-form" enctype="multipart/form-data"
                                            ...
                                            <select name="method" id="method" class="option form-control border mb-3"
                                                ...
                                                @endforeach
                                                 ...
                                                 <div class="icon">
                                                   ...
                                                   {{ $paydata->name }}
@if ($paydata->title != "Cash On Delivery" && $paydata->title != "Stripe")
<button class="copy-btn" onclick="copyToClipboard('{{ $paydata->details }}')">
    <i class="fa fa-copy"></i> انسخ رقم المحفظة لإجراء الدفع
</button>
@endif
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <button type="submit" id="final-btn" class="mybtn1" style="margin-top:45px">
                                                {{ __('Submit')
                                                }}</button>
                                        </div>
                                    </div>
...
<script>
function copyToClipboard(details) {
    let valueToCopy = details.replace(/\D/g, ''); 
