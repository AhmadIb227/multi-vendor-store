            ...
            <div class="row">
               <div class="col-lg-12">
                  <div class="widget border-0 p-40 widget_categories bg-light account-info">
                     <h4 class="widget-title down-line mb-30">{{ __('Edit Profile') }}</h4>
                           ...
                           <div class="edit-info-area-form">
                              ...
                              <form id="userform" action="{{ route('user-profile-update') }}" method="POST"
                                 ...
                                 <div class="row mb-4">
                                    ...
                                    <div class="col-lg-6">
                                       <input name="phone2" type="text" class="input-field form-control border"
                                          placeholder="{{ __('Phone Number2') }}" value="{{ $user->fax }}">
                                    </div>
                                 </div>
                                 <div class="row mb-4">
                                    <div class="col-lg-6">
                                       <select class="input-field form-control border" name="country" id="select_country">
                                    ...
                                    <div class="col-lg-6">
                                       <select class="input-field form-control border" name="state_id" id="show_state">
                                          ...
                                          $states = App\Models\State::whereCountryId($country->id)->whereStatus(1)->get();
                                          @endphp
                                          @foreach($states as $state)
                                          <option value="{{ $state->id }}" {{ $user->state_id == $state->id ? 'selected' : '' }}>{{ $state->state }}</option>
                                          @endforeach
                                          @else
                                 ...
                                 <div class="row mb-4">
                                    <div class="col-lg-6">
                                       <select class="input-field form-control border" name="city_id" id="show_city">
                                          @if ($user->state_id)
                                          @php
                                          $cities = App\Models\City::whereStateId($user->state_id)->whereStatus(1)->get();
                                          @endphp
                                 ...
                                 <div class="row mb-4">
                                    <div class="col-lg-12">
                                       <textarea class="input-field form-control border" name="address"
                                          placeholder="{{ __('Address') }}" cols="30" rows="10" required>{{ $user->address }}</textarea>
                                    </div>
                                 </div>
