...
<style>
    .full-row{
        ...
        .mybtn1 {
    background-color: #7367F0; /* لون خلفية */
    color: #fff; /* لون النص */
    border: none; /* إزالة الحدود */
    padding: 5px 15px; /* تقليل المساحة الداخلية للزر */
    font-size: 14px; /* تقليل حجم النص */
    font-weight: bold; /* سمك النص */
    border-radius: 5px; /* تدوير الحواف */
    width: auto; /* جعل العرض يتناسب مع النص */
    height: auto; /* جعل الطول يتناسب مع المحتوى */
...
.mybtn1:hover {
    background-color: #5a50d8; /* تغيير لون الخلفية عند التحويم */
}
