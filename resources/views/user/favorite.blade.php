...
<div class="full-row bg-light overlay-dark p-3" style="background-image: url({{ $gs->breadcrumb_banner ? asset('assets/images/'.$gs->breadcrumb_banner):asset('assets/images/noimage.png') }}); background-position: center center; background-size: cover;">
   <div class="container">
      <div class="row text-center text-white">
         <div class="col-12">
            <h3 class="mb-2 text-white">{{ __('Favorite Sellers') }}</h3>
         </div>
         <div class="col-12">
            ...
            <div class="row">
               <div class="col-lg-12">
                  <div class="widget border-0 p-40 widget_categories bg-light account-info">
                     <h4 class="widget-title down-line mb-30">{{ __('Favorite Sellers') }}</h4>
                     <div class="mr-table allproduct message-area mt-4">
                        ...
                        <div >
                           ...
                           <table id="example" class="table"  cellspacing="0" width="100%">
                              <thead>
                                 <tr style="background-color:#472C7A ; color:#FFFFFF" >
                                    <th>{{ __('Shop Name') }}</th>
                                    <th>{{ __('Owner Name') }}</th>
                                    <th>{{ __('Address') }}</th>
                                    <th>{{ __('Actions') }}</th>
