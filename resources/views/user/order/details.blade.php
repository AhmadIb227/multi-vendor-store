...
<style>
        ...
        .table-responsive::-webkit-scrollbar-thumb {
            background-color: #C0C0C0; /* Silver color for the thumb */
            border-radius: 10px;
            border: 2px solid #f1f1f1; /* Match track color to avoid border mismatch */
        }

        /* For Firefox */
        .table-responsive {
            scrollbar-color: #C0C0C0 #f1f1f1; /* Thumb color and track color */
                    ...
                    <div class="col-lg-12">
                        <div class="widget border-0 p-40 widget_categories bg-light account-info">
                            ...
                            <div class="view-order-page">
                                <h3 class="order-code">{{ __('Order#') }} {{$order->order_number}} [{{$order->status}}]</h3>
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <p class="order-date mb-0">{{ __('Order Date') }} {{date('d-M-Y',strtotime($order->created_at))}}</p>
                                ...
                                <div class="shipping-add-area">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <address>{{ __('Address') }}: {{$order->pickup_location}}<br></address>
                                            @endif
                                        </div>
                                        <div class="col-md-6">
                                            <h5>{{ __('Shipping Method') }}</h5>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td data-label="{{ __('Total') }}">
                                                    <div>{{ \PriceHelper::showCurrencyPrice(($product['item_price'] * $product['qty'] ) * $order->currency_value) }} <small>{{ $product['discount'] == 0 ? '' : '('.$product['discount'].'% '.__('Off').')' }}</small></div>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                ...
                                <div class="print-order d-flex justify-content-between">
    <a class="back-btn theme-bg mt-3" href="{{ route('user-orders') }}"> {{ __('Back') }}</a>
    <a href="{{route('user-order-print',$order->id)}}" target="_blank" class="btn btn-sm btn-secondary">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="text-center">{{ __('The License Key is :') }} <span id="key"></span></p>
            </div>
