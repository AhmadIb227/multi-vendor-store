...
<li>
    <a href="{{ route('referrals.list', ['referralCode' => 'defaultCode']) }}"><i class="fas fa-upload"></i>{{ __('Referral system') }}</a>
</li>


<!--{{-- <li>-->
<!--    <a href="{{ route('referrals.list') }}"><i class="fas fa-upload"></i>{{ __('Referral system') }}</a>-->
<!--</li> --}}-->
<li>
...
<li>
    <a href="{{route('admin-generate-backup')}}"><i class="fas fa-cog"></i> {{ __('Generate Backup') }}</a>
