...
<style>
 @media screen and (max-width: 767px) {
    ...
    #gallery_09 .owl-carousel .owl-item {
  ...
  <div class="container">
    ...
    <div class="owl-carousel four-carousel dot-disable nav-arrow-middle owl-mx-5">
        @foreach($productt->galleries as $gal)
            <div class="item">
                <a class="active" href="{{asset('assets/images/galleries/'.$gal->photo)}}" data-image="{{asset('photos/'.$gal->photo)}}" 
                data-zoom-image="{{asset('photos/'.$gal->photo)}}">
                          ...
                          <nav class="breadcrumb-divider-slash" aria-label="breadcrumb">
                              <ol class="breadcrumb pro-bread">
                                  ...
                                  <li class="breadcrumb-item">
                                    ...
                                    <a href="{{route('front.category',$productt->category->slug)}}"> {{$productt->category->name_ar}}</a>
                                    @elseif (app()->getLocale() === '17173493681JWu2KUR')
                                          @if (!empty($productt->name_ku))
                                          <a href="{{route('front.category',$productt->category->slug)}}"> {{$productt->category->name_ku}}</a>
                                          @else
                                          <a href="{{route('front.category',$productt->category->slug)}}"> {{$productt->category->name_ar}}</a>
                                          @endif
                                  ...
                                  <a href="{{ route('front.category',[ $productt->category->slug,$productt->subcategory->slug,$productt->childcategory->slug]) }}">
                                    ...
                                    @elseif (app()->getLocale() === '17173493681JWu2KUR')
                                          @if (!empty($productt->name_ku))
                                          <a href="{{ route('front.category',[ $productt->category->slug,$productt->subcategory->slug,$productt->childcategory->slug]) }}">
                                            {{$productt->childcategory->name_ku}}
                                            </a>
                                          @else
                                          <a href="{{ route('front.category',[ $productt->category->slug,$productt->subcategory->slug,$productt->childcategory->slug]) }}">
                         ...
                         <div class="pro-info">
                              ...
                              <p class="price">
                                  <span class="woocommerce-Price-amount amount mr-4">
                                      <bdi>
                                          <span class="woocommerce-Price-currencySymbol" id="sizeprice"> {{ $productt->showPreviousPrice() }}
                                          </bdi>
                                  </span>
                                  <del class="ml-3"><small>{{ $productt->showPrice() }}</small></del>
  ...
  @endif
    ...
    {{-- PRODUCT STOCK CONDITION SECTION ENDS --}}
                      ...
                      <div class="yith-wcwl-add-to-wishlist wishlist-fragment mt-3">
                          ...
                          @if ($productt->type != "Listing")
                            <div class="compare-button" style="
    margin-right: 20px;">
    ...
    @endif
                          ...
                          <div class="my-4 social-linkss social-sharing a2a_kit a2a_kit_size_32">
                              ...
                              <ul class="social-icons py-1 share-product social-linkss py-md-0">
                                 ...
                                 <li>
                                  ...
                                  <li>
                                   <a class="tiktok a2a_button_tiktok" href="">
          ...
          <div class="col-lg-3 col-md-4 visible-sec">
             <div class="pro-details-sidebar-item mb-4">
              ...
              <li class="{{ $gs->is_contact_seller == 0 ? 'contact_seller' : '' }} cnt-sell">
               <a href="{{ route('front.vendor',str_replace(' ', '-', $productt->user->shop_name)).'?instore=1&shop_name='.$productt->user->shop_name.'&email='.$productt->user->email }}" class="view-stor btn--base">
              ...
              <!--@if(isset($productt->user->email))-->
              <!--  <p><strong>{{ __('Email:') }}</strong> {{ $productt->user->email }}</p>-->
              <!--@endif-->
            ...
            @if($gs->is_contact_seller == 1)
              ...
              @if(Auth::check())
                ...
                @if($productt->user_id != 0)
                  ...
                  <a class="view-stor btn--base" href="https://ealanatek.site/user/admin/tickets" data-bs-toggle="modal" data-bs-target="#vendorform">
                    <i class="icofont-ui-chat"></i>
                    {{ __('Contact Seller') }}
                  </a>
                ...
                @else
                  ...
                  <a class="view-stor btn--base" href="https://ealanatek.site/user/admin/tickets" data-bs-toggle="modal" data-bs-target="#sendMessage">
                    <i class="icofont-ui-chat"></i>
                    {{ __('Contact Seller') }}
                  </a>
