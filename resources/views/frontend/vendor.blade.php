...
<div class="bg-zinc-100 min-h-screen" style="background-color: {{ $backgroundColor }};">
  <div class="bg-white shadow  d-flex ">
    ...
    @if($vendor->photo)
      ...
      @else
      <img src="http://16.24.106.161/assets/images/1728163646Annotation2024-09-09011410png.png"  class="w-10 h-10 rounded-full">
...
@endif     
      ...
      <div>
        ...
        @php
              $emailw = request()->get('email');
             if (!$emailw && $vendor->shop_name) {
            $vendorByName = App\Models\User::where('shop_name', $vendor->shop_name)->first();
            if ($vendorByName) {
                $emailw = $vendorByName->email;
            }
          }
        @endphp
      <div class="container mx-auto px-1 py-2 flex space-x-4 res-nav-lg" style="    left: 35px;">
         
        <a href="https://ealanatek.site/" class="text-zinc-800 hover:text-orange-500 ms-2" onclick="openTab(event, 'tab1')">{{('Home')}}</a>
        <a href="https://ealanatek.site/category" class="text-zinc-800 hover:text-orange-500" onclick="openTab(event, 'tab1')">{{('All Products')}}</a>
         <a href="{{ route('front.contactvender', ['email' => $emailw] ) }}" class="text-zinc-800 hover:text-orange-500" onclick="openTab(event, 'tab2')">{{('Contact Us')}}</a>
        <a href="{{ route('aboutus.showd', ['emailw' => $emailw]) }}" class="text-zinc-800 hover:text-orange-500" onclick="openTab(event, 'tab3')">
            {{('About Us')}}
        </a>
      </div>
    ...
    <ul class="cart_list product_list_widget ">
        ...
        <li class="mini-cart-item">
            ...
            <a href="{{ route('front.product', $product['item']['slug']) }}"
             class="product-image"><img  src="{{ $product['item']['photo'] ? filter_var($product['item']['photo'], FILTER_VALIDATE_URL) ?$product['item']['photo']:asset('assets/images/products/'.$product['item']['photo']):asset('assets/images/noimage.png') }}" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" alt="Cart product"></a>
        ...
        @php
              ...
              <a href="{{ $link }}">
                  ...
                  ">
                      ...
                      <!--    <img src="http://16.24.106.161/assets/images/vendorbanner/1721829471m2jpg.jpg" alt="Default Image" style="max-width: 100%; height: auto;"/>-->
                      <!--@endif-->
                  </div>
              </a>
          </div>
              ...
              <div class="row">
                ...
                <div class="col-12 col-md-6 p-1" >
                  @php
                      ...
                      $imageUrl = $vendor->shop_image_left ? url('/assets/images/vendorbanner/' . $vendor->shop_image_left) : 'http://16.24.106.161/assets/images/vendorbanner/1721829471m2jpg.jpg';
                  @endphp
...
{{-- baner3 --}}
              ...
              @php
                  ...
                  $imageUrl = $vendor->shop_image_right ? url('/assets/images/vendorbanner/' . $vendor->shop_image_right) : 'http://16.24.106.161/assets/images/vendorbanner/1721829471m2jpg.jpg';
              @endphp
