                                        ...
                                        <form class="woocommerce-form-login" id="loginform" action="{{ route('user.login.submit') }}" method="POST">
                                            ...
                                            <p>
                                                ...
                                                <input type="email" class="form-control" name="email" id="username"
                                                 placeholder="{{ __('Email Address') }}" required="" > </p>
                                            <p>
                                                <label for="password">{{ __('Password') }}<span span class="required">*</span></label>
                                                <input class="form-control" type="password" name="password" id="password" placeholder="{{ __('Password') }}" required="">
                                            </p>

                                            <div class="d-flex justify-content-between">
                                                <p>
                                                    <a href="{{ route('vendor.register') }}"  class="text-secondary">
                                                        {{ __("Don't have any account?") }}</a>
                                                </p>
                                                <p>
