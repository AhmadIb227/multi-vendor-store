...
<head>
    <style>
        @media print {
            ...
            .full-row.bg-light.overlay-dark.p-3,
            .breadcrumb,
            #common-header,
            #common-footer {
...
<!-- breadcrumb -->
<section class="tempcart" id="printable-area">
...
background-color: #f0f0f0; /* لون المسار الخلفي */
}

.table-responsive::-webkit-scrollbar-thumb {
background-color: #c0c0c0; /* لون شريط التمرير */
border-radius: 10px;
}

/* تغيير لون شريط التمرير على المتصفحات الأخرى */
.table-responsive {
scrollbar-color: #c0c0c0 #f0f0f0; /* شريط التمرير الفضي مع خلفية رمادية */
