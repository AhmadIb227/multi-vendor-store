    ...
    <div class="body bg-zinc-100 min-h-screen">
            ...
            <div class="main-container grid-container grid grid-cols-1 md:grid-cols-2 gap-4 "
                ...
                <div class="form-container p-6 bg-zinc-800 text-white"
                    ...
                    <h2 class="text-2xl font-bold mb-4 text-white">{{ __('Contact the admin') }}</h2>
                    <form class="contactform space-y-4" id="contact-form" action="{{route('front.contactemail')}}" method="POST">
                        @csrf
                        <div class="mb-4">
