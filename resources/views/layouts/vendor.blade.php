					...
					<div class="d-flex mobile-menu-check justify-content-between">
						...
						<div class="right-eliment">
							<ul class="list">
								...
								<li class="login-profile-area" style="margin-right:70px;">
			...
			<div class="wrapper">
				...
				<nav id="sidebar" class="nav-sidebar">
					<ul class="list-unstyled components" id="accordion">
						...
						<li>
							<a href="{{ route('vendor.color.form')}}" class="wave-effect">
								<i class="fas fa-pencil-alt mr-2"></i> {{ __('Set Background Color') }}
							</a>
						</li>
						@endif
						<li>

							<a href="{{ route('aboutus.create') }}" class="wave-effect">
								<i class="fas fa-pencil-alt mr-2"></i> {{ __('Create About Us') }}
							</a>
						</li>
						{{-- @endif --}}
						
						<li>
							<a href="{{ route('user-packages') }}" class="wave-effect">
								<i class="fas fa-pencil-alt mr-2"></i> {{ __('selling Packages') }}
							</a>
						</li>
						<li>
