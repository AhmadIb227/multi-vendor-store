							...
							<div class="product-description">
								<div class="body-area">
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<input type="text" class="input-field" placeholder="{{ __(" Enter Product
												Name") }}" name="name_ar" required="" value="{{ $data->name_ar }}">
										</div>
									</div>
									...
									<div class="row">
										...
										<div class="col-lg-12">
											<input type="text" class="input-field" placeholder="{{ __(" Enter Product
												Name") }}" name="name_ku"  value="{{ $data->name_ku }}">
										</div>
									</div>
													...
													<div class="col-lg-5">
														<div class="custom-control custom-checkbox">
															<input type="checkbox"
																...
																value="{{$option->name}}"
																class="custom-control-input attr-checkbox" @if(is_array($selectedAttrs) && array_key_exists($catAttribute->input_name,$selectedAttrs))
													...
													<div class="col-lg-5">
														<div class="custom-control custom-checkbox">
															<input type="checkbox"
																...
																value="{{$option->name}}"
																class="custom-control-input attr-checkbox" @if(is_array($selectedAttrs) && array_key_exists($subAttribute->input_name,$selectedAttrs))
															@php
															$inName = $subAttribute->input_name;
															@endphp
													...
													<div class="col-lg-5">
														<div class="custom-control custom-checkbox">
															<input type="checkbox"
																...
																value="{{$option->name}}"
																class="custom-control-input attr-checkbox" @if(is_array($selectedAttrs) && array_key_exists($childAttribute->input_name,$selectedAttrs))
															@php
															$inName = $childAttribute->input_name;
															@endphp
															@if (is_array($selectedAttrs["$inName"]["values"]) &&
											...
											<ul class="list">
												<li>
													<input class="checkclickc" name="color_check" type="checkbox"
														id="check3" value="1" {{ !empty($data->color_all) ? "checked":""
													}}>
											...
											<ul class="list">
												<li>
													<input class="checkclicks" name="size_check" type="checkbox"
														id="tcheck" value="1" {{ !empty($data->size_all) ? "checked":""
													}}>
									...
									<div class="">
										<div class="row">
											...
											<div class="col-lg-12">
												...
												@endphp
												<select name="cross_products[]" multiple id="cross_product"
													class="select2">
									...
									<div class="row">
										...
										<div class="row m-auto">
											...
											<div class="col-lg-12" style="text-align: center;margin-top: 15px;">
												<a href="javascript" class="set-gallery addProductSubmit-btn" data-toggle="modal"
										...
										<div class="col-lg-12">
											{{-- <button type="button" style="min-width: 275px;background: red !important;" onclick="removeBackground()" class="addProductSubmit-btn">{{ __('Remove Background') }}</button> --}}
											<script>
												function removeBackground() {
													...
													xhr.open("POST", "/remove-background", true);
