                    ...
                    <div class="product-description">
                      ...
                      @include('alerts.admin.form-both')
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <div class="img-upload full-width-img">
                                <div id="image-preview" class="img-preview" style="background: url({{ asset('assets/admin/images/upload.png') }});margin-bottom:100px" >
                                    <label for="image-upload" class="img-label" id="image-label" style:"" ><i class="icofont-upload-alt"></i>{{ __('Upload Image') }}</label>
                                    <input type="file" name="photo" class="img-upload" id="image-upload">
                                </div>
                                  <p class="text" >{{ __('Prefered Size: (1920x500) or Square Sized Image In Top Slider') }} and {{ __(' (1920x250) Sized Image In Center Slider') }}</p>
                            </div>
                        ...
                        <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading">{{ __('Slider Position') }}*</h4>
                            </div>
                          </div>
                          <div class="col-lg-7">
                              <select  name="slider_position" required="">
                                  <option value="">{{ __('Select Position') }}</option>
