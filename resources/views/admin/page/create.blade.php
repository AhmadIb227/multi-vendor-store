                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusform" action="{{route('admin-page-create')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="title_ar" placeholder="{{ __('Title') }}" required="" value="{{ Request::old('title') }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="title_ku" placeholder="{{ __('Title') }}" required="" value="{{ Request::old('title') }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                              <textarea  class="nic-edit-p" name="details" placeholder="{{ __('Description') }}">{{ Request::old('details') }}</textarea><br>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                              <textarea  class="nic-edit-p" name="details_ar" placeholder="{{ __('Description') }}">{{ Request::old('details') }}</textarea>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                              <textarea  class="nic-edit-p" name="details_ku" placeholder="{{ __('Description') }}">{{ Request::old('details') }}</textarea>
                          </div>
                        </div>
