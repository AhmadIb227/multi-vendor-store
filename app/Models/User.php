...
class User extends Authenticatable implements JWTSubject
{
    ...
    protected $fillable = ['name', 'photo', 'zip', 'background_color' ,
    'referral_link' ,'referral_code' ,'birthdate' ,'points_user', 
    'points_vendor' , 'gender','is_verified',
     'social_id' , 'social_type' , 
    'city_id', 'state_id', 'country', 'address', 'phone', 'Phone Number2', 'email',
   
    'password', 'affilate_code', 'verification_link', 'shop_name', 'owner_name', 'shop_number', 'shop_address', 'reg_number', 'shop_message', 'is_vendor', 'shop_details', 'shop_image', 'shipping_cost', 'date', 'mail_sent', 'email_verified', 'email_token', 'reward','shop_image_left','shop_image_right'];
    ...
    public function subscriptions()
{
    ...
    public function hasNonBasicSubscription()
    {
        $subscriptions = $this->subscriptions()->where('title', '!=', 'Basic')->exists();
        return $subscriptions;
        // $subscriptions = $this->subscriptions()->pluck('title')->toArray();
        // return in_array('Standard', $subscriptions) ||
        //     in_array('Premium', $subscriptions) ||
        //     in_array('Gold6', $subscriptions) ||
        //     in_array('Gold7', $subscriptions);
    }
    public function isStoreOwner()
    {
        return $this->is_vendor === 2;
    }
