...
class CartController extends FrontBaseController
{
    ...
    public function addcart($id)
    {
        ...
        $prod = Product::where('id', '=', $id)->first(['id', 'user_id', 'slug', 'name','name_ar','name_ku', 'photo', 'size', 'size_qty', 'size_price', 'color', 'price', 'stock', 'type', 'file', 'link', 'license', 'license_qty', 'measure', 'whole_sell_qty', 'whole_sell_discount', 'attributes', 'size_all', 'color_all']);
    ...
    public function addtocart($id)
    {
        ...
        $prod = Product::where('id', '=', $id)->first(['id', 'user_id', 'slug', 'name','name_ar','name_ku', 'photo', 'size', 'size_qty', 'size_price', 'color', 'price', 'stock', 'type', 'file', 'link', 'license', 'license_qty', 'measure', 'whole_sell_qty', 'whole_sell_discount', 'attributes', 'minimum_qty', 'size_all', 'color_all']);
    ...
    public function addnumcart(Request $request)
    {
        ...
        $prod = Product::where('id', '=', $id)->first(['id', 'user_id', 'slug', 'name','name_ar','name_ku', 'photo', 'size', 'size_qty', 'size_price', 'color', 'price', 'stock', 'type', 'file', 'link', 'license', 'license_qty', 'measure', 'whole_sell_qty', 'whole_sell_discount', 'attributes', 'minimum_qty', 'stock_check', 'size_all', 'color_all']);
    ...
    public function addbyone()
    {
        ...
        $prod = Product::where('id', '=', $id)->first(['id', 'user_id', 'slug', 'name','name_ar','name_ku', 'photo', 'size', 'size_qty', 'size_price', 'color', 'price', 'stock', 'type', 'file', 'link', 'license', 'license_qty', 'measure', 'whole_sell_qty', 'whole_sell_discount', 'attributes', 'stock_check',]);
    ...
    public function reducebyone()
    {
        ...
        $size_qty = $_GET['size_qty'];
        $size_price = $_GET['size_price'];
        $prod = Product::where('id', '=', $id)->first(['id', 'user_id', 'slug', 'name','name_ar','name_ku', 'photo', 'size', 'size_qty', 'size_price', 'color', 'price', 'stock', 'type', 'file', 'link', 'license', 'license_qty', 'measure', 'whole_sell_qty', 'whole_sell_discount', 'attributes']);
        if ($prod->user_id != 0) {
            $prc = $prod->price + $this->gs->fixed_commission + ($prod->price / 100) * $this->gs->percentage_commission;
            $prod->price = $prc;
        }
