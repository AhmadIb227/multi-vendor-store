    ...
    public function datatables()
{
    ...
    return Datatables::of($datas)
        ...
        ->addColumn('action', function(Shipping $data) {
            return '<div class="action-list"><a data-href="'
             . route('vendor-shipping-edit', $data->id) 
             . '" class="edit" data-toggle="modal" data-target="#modal1">
              <i class="fas fa-edit"></i>' 
              . __('Edit') . '</a><a href="javascript:;" data-href="' 
              . route('vendor-shipping-delete', $data->id) 
    ...
    public function store(Request $request)
    {
        ...
        $customs = [
            'title.unique' => __('This English title has already been taken.'),
        ];
