...
class VendorResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
          ...
          'shop_image_left' => $this->shop_image_left ? url('/') . '/assets/images/vendorbanner/' . $this->shop_image_left : '#6f1ed6',
          'shop_image_right' => $this->shop_image_right ? url('/') . '/assets/images/vendorbanner/' . $this->shop_image_right : '#6f1ed6',
          'facebook' => [
            'url' => $this->f_url,
